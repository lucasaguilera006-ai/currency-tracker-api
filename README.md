...
Endpoint /latest en funcionamiento:
...
Configurá la cadena de conexión a tu base de datos en appsettings.json.
...
bash
   dotnet run
Abrí Swagger en el navegador (por defecto en http://localhost:5243/swagger) para probar los endpoints.
📄 Licencia
